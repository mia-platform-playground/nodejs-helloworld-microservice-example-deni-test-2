# nodejs-helloworld-microservice-example-2
...
```json
{"name":"nodejs-helloworld-microservice-example-2","status":"OK","version":"0.1.0"}
```

[nvm]: https://github.com/creationix/nvm
[merge-request]: https://github.com/mia-platform-playground/nodejs-helloworld-microservice-example-deni-test-2/merge_requests
